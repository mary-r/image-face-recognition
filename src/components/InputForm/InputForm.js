    ...
    return (
        <div>
            ...
            <div className='center'>
                <article className='form pa4 br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw8 shadow-5 center'>
                    <input className='ba b--black-20 pa2 mb2 db w-100 input' type='text' onChange={onInputChange} />
